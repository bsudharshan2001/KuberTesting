...
class DbHelper {
  ...
  void addData(int amount, DateTime date, String type, String note, String dropdownValue) async {
    var value = {'amount': amount, 'date': date, 'type': type, 'note': note, 'category':dropdownValue};
    print(value);
    box.add(value);
  }
